 ...
 */
public class CopyOfUserProcess {
    /**
     * Allocate a new process.
     */
    public CopyOfUserProcess() {
     ...
     */
    public static CopyOfUserProcess newUserProcess() {
	return (CopyOfUserProcess)Lib.constructObject(Machine.getProcessClassName());
    }
